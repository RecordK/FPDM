...
class FPDM_DiffusionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        prior_embed = fusion_img_embed.repeat(bs * num_images_per_prompt, 1, 1).to(
...
#
# class Simple_InpaintDiffusionPipeline(DiffusionPipeline):
#     _optional_components = []
#
#     def __init__(
#         self,
#         vae: AutoencoderKL,
#         unet: InapintUNet2DConditionModel,
#         scheduler: Union[
#             DDIMScheduler,
#             PNDMScheduler,
...
#             return (image, has_nsfw_concept)
#
#         return InpaintDiffusionPipelineOutput(images=image, nsfw_content_detected=has_nsfw_concept)
